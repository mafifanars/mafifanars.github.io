            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full self-end px-4 lg:w-1/2">
                    <div class="relative mt-10 lg:mt-0 lg:right-0">
                        <img src="<?php echo e(asset('img/scolar-mockup.png')); ?>" alt="logo-scholarfy" class="relative z-10 max-w-full w-60 md:w-72 mx-auto">
            ...
            <div class="w-full px-4 flex flex-wrap justify-center xl:w-11/12 xl:mx-auto">
                <div class="mb-12 p-4 md:w-1/2">
                    <div class="flex items-center justify-center">
                        <img src="<?php echo e(asset('img/Scolar Book Mockup 2_nobg.png')); ?>" alt="Gambar Buku" class="w-72 lg:w-80">
                    </div>
                </div>
                <div class="mb-12 p-4 md:w-1/2">
...
</html><?php /**PATH D:\Mhd Afifan Aly Rahman Saragih\Teknologi Informasi '20\Competition\PKM 2023 - Scolar\Website\komikscolar.id\resources\views/app.blade.php ENDPATH**/ ?>
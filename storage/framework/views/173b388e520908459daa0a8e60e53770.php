            ...
            <div class="w-full self-center px-4 bg-gradient-to-r from-primary to-indigo-500 mx-auto rounded-xl py-6">
                <div class="flex justify-center">
                    <div class="w-20 h-20 rounded-full overflow-hidden bg-white">
                        <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Profile Picture" class="object-cover w-full h-full">
                    </div>
                </div>
                <div class="px-4 mb-6">
...
</html><?php /**PATH D:\Mhd Afifan Aly Rahman Saragih\Teknologi Informasi '20\Competition\PKM 2023 - Scolar\Website\komikscolar.id\resources\views/get-in-touch.blade.php ENDPATH**/ ?>